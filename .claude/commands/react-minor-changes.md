...
Use this command for low-risk, focused updates in React/TypeScript code (typically 1-3 files), where behavior should stay consistent and scope should stay small.
